...
public class ModificarLugarDeRealizacion extends JDialog {
    ...
    public ModificarLugarDeRealizacion() {
        this(null, "", false);
    }

    public ModificarLugarDeRealizacion(Frame parent, String title, boolean modal) {
        super(parent, title, modal);
        try {
