...
public class Alta extends JDialog {
    ...
    public Alta(Usuario usuarioLogueado) {
    ...
    public Alta(Frame parent, String title, boolean modal, Usuario usuarioLogueado) {
    ...
    public Alta(Frame parent, String title, boolean modal) {
        super(parent, title, modal);
        try {
